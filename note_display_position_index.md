...
6. Элементы, идущие подряд, не переносятся на другую строку, располагаются на одной
строке.
...
Внимание! Если вы хотите добавить позиционирование отдельного элемента из flex-контейнера, вам необходимо задать класс к данному элементу. Не пугайтесь, если классов будет несколько. Например: <div class="item item_center">, и далее задавать
